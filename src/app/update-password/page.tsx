  ...
  return (
    <main className="shell flex min-h-screen items-center justify-center py-10">
      <section className="card w-full max-w-md p-7 sm:p-9">
        <p className="text-sm font-bold uppercase tracking-[.12em] text-[var(--rcg-orange)]">Account access</p>
        ...
        <form action={updateRecoveredPassword} className="mt-6 space-y-4">
          ...
          <div><label className="mb-1 block text-sm font-bold" htmlFor="confirmPassword">Confirm password</label><input className="input" id="confirmPassword" name="confirmPassword" type="password" autoComplete="new-password" minLength={10} required /></div>
