  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <div className="flex flex-wrap gap-2"><Link className="btn btn-secondary" href="/admin/users">Manage users</Link><Link className="btn btn-secondary" href="/admin/audit">Audit log</Link></div>
      </div>
