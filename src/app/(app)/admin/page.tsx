  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div><p className="text-sm font-bold uppercase tracking-[.12em] text-[var(--rcg-orange)]">Site safety</p><h1 className="mt-1 text-3xl font-black">Admin dashboard</h1><p className="mt-2 text-[var(--rcg-muted)]">Live presence, reporting and operational controls.</p></div>
        <div className="flex flex-wrap gap-2">
          <Link className="btn btn-secondary" href="/admin/users">Manage users</Link>
          <Link className="btn btn-secondary" href="/admin/reports">Reports & exports</Link>
